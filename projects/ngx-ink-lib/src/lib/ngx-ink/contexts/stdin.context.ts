...
export type StdinContextValue = PublicStdinProps & {
    /**
...
const defaultStdinContext: StdinContextValue = {
    stdin: process.stdin,
...
export const STDIN_CONTEXT_TOKEN = new InjectionToken<Signal<StdinContextValue>>('StdinContext', {
    factory: () => signal(defaultStdinContext),
});
