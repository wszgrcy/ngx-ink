...
import { createNode } from './angular-dom.js';
import { ApplicationRef, Injector } from '@angular/core';
import { type TerminalSuspension } from './contexts/app.context.js';
...
export default class Ink {
    ...
    #injector;
    constructor(options: Options, injector: Injector) {
    ...
    unmount(error?: Error | number | null): void {
        ...
        if (!appRef.destroyed) {
            this.#injector.get(ApplicationRef).destroy();
        }
        finishUnmount();
    }
